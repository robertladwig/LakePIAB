...
df.to_csv('../verification/dl_temp_25.csv', index=None)
...
df.to_csv('../verification/dl_icesnow_25.csv', index=None)
...
df = pd.concat([df1, df2], axis = 1)
df.to_csv('../verification/dl_meteorology_25.csv', index=None)