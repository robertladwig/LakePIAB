...
df.to_csv('../stability/py_temp_initial00.csv', index=None)
...
df2 = pd.DataFrame(t1)
df = pd.concat([df1, df2], axis = 1)
df.to_csv('../stability/py_temp_heat01.csv', index=None)
...
df2 = pd.DataFrame(t1)
df = pd.concat([df1, df2], axis = 1)
df.to_csv('../stability/py_temp_diff02.csv', index=None)
...
df2 = pd.DataFrame(t1)
df = pd.concat([df1, df2], axis = 1)
df.to_csv('../stability/py_temp_mix03.csv', index=None)
...
df2 = pd.DataFrame(t1)
df = pd.concat([df1, df2], axis = 1)
df.to_csv('../stability/py_temp_conv04.csv', index=None)
...
df2 = pd.DataFrame(t1)
df = pd.concat([df1, df2], axis = 1)
df.to_csv('../stability/py_temp_total05.csv', index=None)
