...
hy <- read.csv("verification/hy_temp_25.csv")
hy_met <- read.csv("verification/hy_meteorology_25.csv")

dl <- read.csv("verification/dl_temp_25.csv")
dl_met <- read.csv("verification/dl_meteorology_25.csv")
...
dl_noMod <- read.csv("verification/dlnoM_temp_25.csv")
dl_noMod_met <- read.csv("verification/dlnoM_meteorology_25.csv")
...
ggsave(plot = p3, filename = "figs/Fig5_25.png", dpi = 300, width = 9, height =5, units = 'in')
...
ggsave(plot = p1, filename = "figs/Fig3_25.png", dpi = 300, width = 15, height =11, units = 'in')
...
ggsave(plot = p2, filename = "figs/Fig4_25.png", dpi = 300, width = 15, height = 9, units = 'in')

p3 <- p1 / p2 + plot_layout(widths = c(2,2,2,2,2), heights = unit(c(4,4,4,4, 14), c('cm', 'cm', "cm", "cm", "cm")))
ggsave(plot = p3, filename = "figs/combined_Fig3+4_25.png", dpi = 300, width = 10, height = 16, units = 'in')
