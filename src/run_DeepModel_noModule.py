...
df.to_csv('../verification/dlnoM_temp.csv', index=None)
...
df.to_csv('../verification/dlnoM_icesnow.csv', index=None)
...
df = pd.concat([df1, df2], axis = 1)
df.to_csv('../verification/dlnoM_meteorology.csv', index=None)